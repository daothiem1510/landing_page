        ...
        <table class="table datatable-basic">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$record->title}}</td>
                    <td class="text-center">
                        <a href="{{route('admin.head.edit', $record->id)}}" title="{!! trans('base.edit') !!}" class="success"><i class="icon-pencil"></i></a>
                        <form action="{!! route('admin.head.destroy', ['id' => $record->id]) !!}" method="POST" style="display: inline-block">
                            {!! method_field('DELETE') !!}
                            {!! csrf_field() !!}
