                    ...
                    <form action="{!!route('admin.size.store')!!}" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control alias-product" name="weight" value="{!!old('weight')!!}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control alias-product" name="height" value="{!!old('height')!!}">
