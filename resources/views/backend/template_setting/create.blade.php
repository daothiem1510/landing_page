                        ...
                        <form method="post" action="{!!route('admin.template_setting.store')!!}" class="form-horizontal form-validate-jquery">
                            ...
                            <fieldset>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label text-right">Chọn sản phẩm <span class="text-danger">*</span></label>
                                    <div class="col-md-9">
                                        <select class="select-search form-control" name="product_html" data-placeholder="Chọn sản phẩm" required>
                                            {!!$product_html!!}
                                        </select>
