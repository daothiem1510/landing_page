...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.customer.index')}}" method="GET" enctype="multipart/form-data">
                <div class="row">
                    <div class="form-group col-md-6">
                        <label>Tên khách hàng</label>
                        <select class="select-search form-control" name="id" data-placeholder="Chọn tên khách hàng">
                            {!!$customer_html!!}
                        </select>
                    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                            <a href="{{route('admin.customer.edit', $record->id)}}" title="Chỉnh sửa"><i class="icon-pencil"></i></a>
                        <form action="{!! route('admin.customer.destroy', ['id' => $record->id]) !!}" method="POST" style="display: inline-block">
                            {!! method_field('DELETE') !!}
                            {!! csrf_field() !!}
