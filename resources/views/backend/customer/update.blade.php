                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" name="email" value="{!! $customer->phone !!}" required="">
                                            {!! $errors->first('tax_code', '<span class="text-danger">:message</span>') !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="radio" id="male" @if($customer->sex == 0) checked @endif name="sex" value="0" required="">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="female">Nữ</label>
                                            <input type="radio" id="female" @if($customer->sex == 1) checked @endif name="sex" value="1" required="">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="other">Khác</label>
                                            <input type="radio" id="other" @if($customer->sex == 2) checked @endif name="sex" value="2" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
