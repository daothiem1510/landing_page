    ...
    <div class="content page-order">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{!!route('admin.order.update', $record->id)!!}" id="frmOrder" method="POST" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control"  name="unit" value="{!!old('unit')?:$record->unit!!}" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control"  name="contact" value="{!!old('contact')?:$record->contact!!}" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-md-9">
                                        ...
                                        <input type="text" class="form-control pickadate" placeholder="Ngày bắt đầu" name="date" required value="{{$record->date}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="product">
                                    @foreach($record->orderDetail as $val)
                                        <div class="row border-top-1 mb-1 pt-3 item" >
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input name="" value="{{$val->accessory->name}}" type="text" class="accessory_name form-control validate" readonly>
                                            </div>
                                            <div class="form-group col-md-2">
                                            ...
                                            <div class="form-group col-md-1">
                                                ...
                                                <input name="weight_b[]" type="text" class="weight_b form-control validate" value="{{$val->weight_b}}">
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label class="required">TL (mỗi cái)</label>
                                                <input name="weight_c[]" type="text" class="weight_c form-control validate" value="{{$val->weight_c}}">
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label class="required">Lỗ khuôn</label>
                                                <input name="pattern[]" type="number" min="0" class="form-control pattern" readonly value="{{$val->pattern}}">
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label class="required">Chu kì</label>
                                                <input name="period[]" type="text" class="form-control period validate" value="{{$val->period}}">
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label class="required">SLYC</label>
                                                <input id="quantity[]" autocomplete="off" onkeyup="formatValue(this)" type="text" class="form-control quantity_format validate" value="{{number_format($val->quantity)}}">
                                                <input type="hidden" name="quantity[]"  class="form-control quantity" value="{{$val->quantity}}">
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label class="required">Đơn giá</label>
                                                <input id="price[]" autocomplete="off" onkeyup="formatValue(this)" type="text" class="form-control price_format validate" value="{{$val->price}}">
                                                <input type="hidden" name="price[]" class="form-control price " value="{{$val->price}}">

                                            </div>
                                            <div class="form-group col-md-2">
                                                <label class="required">Thành tiền</label>
                                                <input id="into_money[]" autocomplete="off" onkeyup="formatValue(this)" type="text" class="form-control into_money_format validate" value="{{number_format($val->quantity*$val->price)}}" readonly>
                                                <input type="hidden" name="into_money[]" class="form-control into_money" value="{{$val->quantity*$val->price}}">
                                            </div>
                                ...
                                <div class="row border-top-1 mb-1 pt-1">
                                    <div class="col-md-12 text-right">
                                        <h5>Tổng: <span class="total">{{number_format($record->total_order)}}</span></h5>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="text-left mt-4 ">
                                ...
                                <button class="btn btn-primary legitRipple" data-action="save-order">Lưu lại <i class="icon-arrow-right14 position-right"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        $('#btn_add').click(function (){
            $('.product').append(`
                ...
                {!! $color_html !!}
                        ...
                        <div class="form-group col-md-1">
                            <label class="required">TL (mỗi bìa)</label>
                            <input name="weight_b[]" value="" type="text" class="weight_b form-control validate">
                        </div>
                        <div class="form-group col-md-1">
                            <label class="required">TL (mỗi cái)</label>
                            <input name="weight_c[]" value="" type="text" class="weight_c form-control validate">
                        </div>
                        <div class="form-group col-md-1">
                            <label class="required">Lỗ khuôn</label>
