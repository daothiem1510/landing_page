...
class SectionTemplateAttribute extends Controller
{
    ...
    {
        $page_html = StringHelper::getSelectOptions($this->pageRepo->all());
    ...
    public function store(Request $request) {
        ...
        foreach ($input['name'] as $key => $name) {
            ...
            $this->menuDetailRepo->all($detail);
        }
    ...
    public function edit($id)
    {
        ...
        $page_html = StringHelper::getSelectOptions($this->pageRepo->all(),$record->page_id);
