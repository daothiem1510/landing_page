...
class TemplateSettingRepository extends AbstractRepository
{
    ...
    public function getAll(){
        $records = $this->model
            ->join('template_attribute','template_setting.attribute_id','template_attribute.id')
            ->select('template_setting.name', 'template_setting.value', 'template_attribute.title')->get();
        $result = array();
